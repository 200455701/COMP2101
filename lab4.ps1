...
NumberOfCores, @{n="L1CacheSize";e={switch($_.L1CacheSize){$null{$var="Info is not available.."}};$var}}, L2CacheSize, L3CacheSize
}
...
{$NULL{$var="Info is not available.."; $var}};if($null -ne $_.DNSServerSearchorder){$_.DNSServerSearchorder}}},
@{n="DNSDomain";
e={switch($_.DNSDomain)
{$NULL{$var="Info is not available..";$var }};if($null -ne $_.DNSdomain){$_.DNSdomain}}}
}
